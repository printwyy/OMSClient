...
import ActivePlotter from './ActivePlotter';
    ...
    render() {
        ...
        if (docked) {
            return (
                <div>
                    {toggleDockedBtn}
                    <ActivePlotter variables={variables} simRes={simRes}/>
                </div>);
        }
        ...
        const portals = windowIds.map(windowId => (
            ...
            >
                ...
                <ActivePlotter variables={plotWindows[windowId].variables} simRes={simRes}/>
            </PortalWindow>
        ));
