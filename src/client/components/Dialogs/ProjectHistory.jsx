                    ...
                    >
                        ...
                        >
                            ...
                            <Grid item xs={1} zeroMinWidth>
                                <Tooltip id="revert-tooltip" title="返回该版本">
                                    <IconButton
                                ...
                                <Tooltip id="read-only-view-tooltip" title="检查版本">
                                    <IconButton
                                        style={{height: 22, width: 30, visibility: current ? 'hidden' : undefined}}
                                        onClick={() => {
        ...
        return (
            <Dialog maxWidth="md" open>
                ...
                <DialogActions>
                    ...
                    <Button onClick={this.props.onOK} color="primary">返回</Button>
                </DialogActions>
